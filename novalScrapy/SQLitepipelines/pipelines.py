...
from .sql import Sql
from novalScrapy.items import NovalscrapyItem,DcontentItem

class NovalPipeline(object):
    def process_item(self, item, spider):
        if isinstance(item, NovalscrapyItem):
            ...
            if ret[0] == 1:
                ...
                print(u'start save the noval title')
        ...
        print(u'%s finsh saving') % xs_chaptername
        return item
